  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px, rgba(202, 138, 4, 0.4) 1.5px, transparent 0)", // Changed to dark yellow (yellow-600) with 0.4 opacity
      ...
      >
        ...
        <div className="mx-auto max-w-2xl md:py-16 py-28 px-4 sm:px-0">
          ...
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl font-sans font-bold translate-y-[100px] opacity-0 animate-[slideUp_1s_ease-out_forwards]">
              {" "}
              Transcode
            ...
            <p className="mt-8 font-semibold text-xl leading-8 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto opacity-0 animate-[fadeIn_1s_ease-out_0.5s_forwards]">
              Transcode your videos with the best quality and fastest speed
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6 opacity-0 animate-[slideInFromBottom_1s_ease-out_0.8s_forwards]">
              <a
                href="#"
                className="group flex h-10 items-center justify-center rounded-md border border-yellow-600 bg-gradient-to-b from-yellow-400 via-yellow-500 to-yellow-600 px-4 text-neutral-50 shadow-[inset_0_1px_0px_0px_#fcd34d] active:[box-shadow:none]"
              >
                <span className="block group-active:[transform:translate3d(0,1px,0)] text-black">
                  Get started
                </span>
              </a>
